...
{- Languages
   ...
   favorite is not in there you can add them here. The most common commenting
   ...
   language. In this example we add some esoteric languages.
-}
...
{- Database
   ...
   effect.
-}
let database = Some ".entangled/sqlite.db"
